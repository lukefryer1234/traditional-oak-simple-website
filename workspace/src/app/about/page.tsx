              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 my-10 not-prose">
                  <div className="relative aspect-[4/3] rounded-lg overflow-hidden shadow-md bg-muted">
                      <Image
                          ...
                          fill style={{objectFit:"cover"}} data-ai-hint="oak wood traditional joinery close up detail"
                      />
                  </div>
                   <div className="relative aspect-[4/3] rounded-lg overflow-hidden shadow-md bg-muted">
                       <Image
                          ...
                          fill style={{objectFit:"cover"}} data-ai-hint="stack of european oak timber beams yard"
                      />
                   </div>
              </div>
