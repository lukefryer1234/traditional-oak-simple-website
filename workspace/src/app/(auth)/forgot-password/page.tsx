...
// import { auth } from '@/lib/firebase'; // Now using auth from context
...
export default function ForgotPasswordPage() {
  ...
  const handlePasswordReset = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      await sendPasswordReset(email); // Use sendPasswordReset from context
      ...
      setError(errorMessage); // Set error in context
